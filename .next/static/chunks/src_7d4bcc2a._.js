...
"[project]/src/shared/store/hooks/useAppInitialization.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_s(useAppInitialization, "WjGN3/kkV2MVa25OUBQ8vZP0I4A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$auth$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$user$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2f$useAppInitialization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/store/hooks/useAppInitialization.ts [app-client] (ecmascript)");
;
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
const useAppRouteGuard = ()=>{
    ...
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const { isAppReady, isUserLoaded, isAuthenticated, setCurrentPath, setUserLoaded } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2f$useAppInitialization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppInitialization"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(useAppRouteGuard, "pOqjZv3qMmd4JDopeWzsUt7C+vY=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2f$useAppInitialization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppInitialization"]
    ];
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
{
const e = new Error("Could not parse module '[project]/src/widgets/AppLayout/AppLayout.tsx'\n\nUnterminated regexp literal");
...
const AppInitializer = (param)=>{
    let { children } = param;
    _s();
    const { token, isAuthenticated, setUser, isLoading, isAppReady } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { setUserLoaded, initializeRouter } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2f$useAppInitialization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppInitialization"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppInitializer.useEffect": ()=>{
            ...
            const checkExistingAuth = {
                "AppInitializer.useEffect.checkExistingAuth": async ()=>{
                    const storedToken = localStorage.getItem('auth-token');
                    if (storedToken && !isAuthenticated) {
                        // If we have a token but user is not authenticated, try to restore user data
                        // In a real app, you would validate the token with your API
                        // For now, we'll simulate this by checking if we have user data in localStorage
                    ...
                    // Mark user as loaded after checking auth state
                    setUserLoaded(true);
                }
            }["AppInitializer.useEffect.checkExistingAuth"];
            checkExistingAuth();
        }
    }["AppInitializer.useEffect"], [
        initializeRouter,
...
_s(AppInitializer, "CIKs3FHDLAZZSizQEJtM5bga2ls=", false, function() {
    return [
...
//# sourceMappingURL=src_7d4bcc2a._.js.map
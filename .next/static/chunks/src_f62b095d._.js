...
;
const Header = (param)=>{
    let { onMenuToggle, user, onLogout, onLogin } = param;
    _s();
...
_s(useAuth, "NppuFfDC0q53RuyccIclrMNdvWA=", false, function() {
    return [
...
const useAppInitialization = ()=>{
    ...
    return {
        // Combined state
        isAppReady: router.isInitialized && router.isUserLoaded,
        isUserLoaded: router.isUserLoaded,
        isInitialized: router.isInitialized,
        isAuthenticated: auth.isAuthenticated,
        user: user.user,
        isLoading: auth.isLoading || user.isLoading,
        // Actions
        setUserLoaded: router.setUserLoaded,
        setInitialized: router.setInitialized,
        setCurrentPath: router.setCurrentPath,
        initializeRouter: router.initializeRouter
    };
};
_s1(useAppInitialization, "WjGN3/kkV2MVa25OUBQ8vZP0I4A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$auth$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$user$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"],
...
"[project]/src/shared/store/index.ts [app-client] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "useAuth": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
    "useAuthStore": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$auth$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
    "useRouterStore": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$router$2f$routerStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouterStore"],
    "useUserStore": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$user$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserStore"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$auth$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/store/auth/authStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$user$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/store/user/userStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$router$2f$routerStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/store/router/routerStore.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/src/shared/store/index.ts [app-client] (ecmascript) <exports>");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
...
const useAppRouteGuard = ()=>{
    ...
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const { isAppReady, isUserLoaded, isAuthenticated, setCurrentPath, setUserLoaded } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["useAppInitialization"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAppRouteGuard.useEffect": ()=>{
            // Set current path in router store
    ...
    // Mark user as loaded when authentication state is determined
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAppRouteGuard.useEffect": ()=>{
            if (!isUserLoaded) {
                setUserLoaded(true);
...
_s(useAppRouteGuard, "pOqjZv3qMmd4JDopeWzsUt7C+vY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["useAppInitialization"]
    ];
});
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
const AppLayout = (param)=>{
    ...
    const { isAuthenticated, user, login, logout, setUser, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { isAppReady, initializeRouter } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["useAppInitialization"])();
    ...
    // New route guard that waits for user loading
    const { isUserLoaded } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$useAppRouteGuard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppRouteGuard"])();
    ...
    const handleLogout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppLayout.useCallback[handleLogout]": ()=>{
            logout();
            setUser(null);
            localStorage.removeItem('auth-token');
    ...
    const handleLogin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppLayout.useCallback[handleLogin]": ()=>{
            login('dummy-token');
            setUser({
                id: '1',
                name: 'John Doe',
...
_s(AppLayout, "sZmDS5WPTpMwHh+rqud8Nkbdszw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["useAppInitialization"],
...
//# sourceMappingURL=src_f62b095d._.js.map